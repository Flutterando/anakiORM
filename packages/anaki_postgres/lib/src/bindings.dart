...
const String _assetId = 'package:anaki_postgres/anaki_postgres.dart';
...
class AnakiPostgresBindings {
  ...
  /// fall back to [AnakiPostgresBindings.fromLibrary].
  factory AnakiPostgresBindings.fromNativeAssets() {
    return AnakiPostgresBindings._(
  ...
  factory AnakiPostgresBindings.fromLibrary(DynamicLibrary lib) {
    return AnakiPostgresBindings._(
