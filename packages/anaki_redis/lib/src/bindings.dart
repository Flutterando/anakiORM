...
const String _assetId = 'package:anaki_redis/anaki_redis.dart';
...
class AnakiRedisBindings {
  ...
  /// fall back to [AnakiRedisBindings.fromLibrary].
  factory AnakiRedisBindings.fromNativeAssets() {
    return AnakiRedisBindings._(
  ...
  factory AnakiRedisBindings.fromLibrary(DynamicLibrary lib) {
    return AnakiRedisBindings._(
