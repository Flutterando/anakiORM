...
const String _assetId = 'package:anaki_mongodb/anaki_mongodb.dart';
...
class AnakiMongoDbBindings {
  ...
  /// fall back to [AnakiMongoDbBindings.fromLibrary].
  factory AnakiMongoDbBindings.fromNativeAssets() {
    return AnakiMongoDbBindings._(
  ...
  factory AnakiMongoDbBindings.fromLibrary(DynamicLibrary lib) {
    return AnakiMongoDbBindings._(
