...
const String _assetId = 'package:anaki_mysql/anaki_mysql.dart';
...
class AnakiMysqlBindings {
  ...
  /// fall back to [AnakiMysqlBindings.fromLibrary].
  factory AnakiMysqlBindings.fromNativeAssets() {
    return AnakiMysqlBindings._(
  ...
  factory AnakiMysqlBindings.fromLibrary(DynamicLibrary lib) {
    return AnakiMysqlBindings._(
